...
`coolms/core` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/core 2.0.0` does not assert that this package broke something; it
