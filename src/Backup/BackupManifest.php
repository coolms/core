...
/**
 * The `manifest.json` at a bundle's root -- the bundle FORMAT, which is why it
 * is declared here rather than with the engine that writes one: an edge pulling
 * a snapshot reads a manifest without owning a backup engine, and the format is
