 ...
 * Core Extension) by {@see \CoolMS\Core\Application\Backup\BackupRunner} so the
...
interface BackupContributorInterface
{
     ...
     * the "synced universe" programmatically enumerable ({@see \CoolMS\Core\Application\Backup\BackupTableRegistry}
