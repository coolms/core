 ...
 *
 * !! The body is whatever the platform already stores, not a theme-specific
...
interface SeedTargetInterface
{
     ...
     *
     * !! This doubles as the occupancy answer, so the distinction between null
     ...
     *
     * !! MERGE, never replace: the extras bag holds other seeders' markers and
